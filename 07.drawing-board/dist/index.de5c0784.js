...
class DrawingBoard {
    ...
    initBackgroundColor() {
        ...
        this.context.fillRect = (this.canvasEl.width, this.canvasEl.height);
    }
    addEvent() {
    ...
    onClickNavigator(event) {
        this.isNavigatorVisable = !event.currentTarget.classList.contains("active");
        event.currentTarget.classList.toggle("active");
        this.navigatorImageContainerEl.classList.toggle("hide");
        this.updateNavigator();
    }
    updateNavigator() {
        if (!this.isNavigatorVisable) return;
        this.navigatorImageEl.src = this.canvasEl.toDataURL();
    }
    onClickEraser(event) {
        const IsActive = event.currentTarget.classList.contains("active");
        this.MODE = IsActive ? "NOME" : "ERASER";
